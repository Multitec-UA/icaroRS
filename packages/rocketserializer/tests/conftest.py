...
with orhelper.OpenRocketInstance("OpenRocket-23.09.jar", "OFF") as instance:
    ...
    # MT1 2026
    filepath = "examples/MT1--2026/v1.5.0/rocket.ork"
    output = "tests/acceptance/MT1--2026/"
    ork = orh.load_doc(filepath)
    settings4 = get_settings(filepath, output, ork)
    with open(output + "parameters.json", "w", encoding="utf-8") as f:
        json.dump(settings4, f, indent=4, ensure_ascii=False)
